...
class EngineGateway {
    ...
    async command(name, payload) {
        switch (name) {
            ...
            case 'library:scan':
                return this.request('/library/scan', { method: 'POST', body: payload });
            case 'queue-add':
                return this.request('/queue/add', { method: 'POST', body: payload });
            case 'queue-next':
                return this.request('/queue/next', { method: 'POST' });
            case 'command':
                return this.request('/command', { method: 'POST', body: payload });
            case 'cover':
                return this.request('/cover', { method: 'POST', body: payload });
            case 'capture-start':
